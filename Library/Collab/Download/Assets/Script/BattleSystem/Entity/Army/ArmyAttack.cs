...
namespace Canute.BattleSystem
{
    public static class ArmyAttack
    {
        ...
        public static bool PrepareAttack(Effect effect, ArmyEntity armyEntity)
        {
            ...
            expectedTargets = armyEntity.GetPossibleTargets().Select((IPassiveEntity a) => { return a as Entity; }).ToList();
        ...
        /// <returns></returns>
        public static List<IPassiveEntity> GetPossibleTargets(this IAggressiveEntity entity)
        {
            List<IPassiveEntity> possibleTargets = new List<IPassiveEntity>();
            List<CellEntity> cellEntities = entity.Data.GetAttackArea();
            for (int i = cellEntities.Count - 1; i >= 0; i--)
            {
                ...
                ArmyEntity possibleTarget = cellEntity.HasArmyStandOn;
